...
/home/qemu-2021/build/qemu-system-riscv32 -name guest=rv32 -M virt  -bios bin/rv32fw_jump.elf -kernel bin/Core.v32.qemu -append "root=/dev/vda ro" -netdev user,id=net0 -device virtio-net-device,netdev=net0 -device bochs-display -display gtk -monitor stdio -device virtio-blk-device,drive=hd0 -drive file=/home/images/gigdisk.img,format=raw,id=hd0
